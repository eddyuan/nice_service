...
class NSMaterialApp extends StatelessWidget {
  const NSMaterialApp({
    super.key,
    this.navigatorKey,
  ...
  /// and list the [locales] that the application can handle.
  ///
  /// ```dart
  ...
  /// See also:
  ///
  ///  * [locales], which must be specified along with
    ...
    return NSRoot(
      ...
      builder: (
        ...
        return MaterialApp(
          ...
          supportedLocales: config.supportedLocales.isEmpty
              ? const [Locale('en', 'US')]
